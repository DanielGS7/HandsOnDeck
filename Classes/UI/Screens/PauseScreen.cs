...
namespace HandsOnDeck2.Classes.UI.Screens
{
    public class PauseScreen : Screen
    {
        ...
        public override void Initialize()
        {
            ...
            AddButton("Exit and Save", new Vector2(0.5f, 0.7f), new Vector2(0.3f, 0.1f), 0f, "wood_button", ExitAndSave);
            AddButton("Main Menu", new Vector2(0.5f, 0.85f), new Vector2(0.3f, 0.1f), 0f, "wood_button", ReturnToMainMenu);
        }
        ...
        {
            Game1.Instance.SaveCurrentGame();
