...
namespace HandsOnDeck2.Classes.UI.Screens
{
    public class SettingsScreen : Screen
    {
        ...
        public override void Initialize()
        {
            ...
            AddButton("Apply", new Vector2(0.4f, 0.7f), new Vector2(0.2f, 0.1f), 0f, "UI\\wood_button", ApplySettings);
            AddButton("Back", new Vector2(0.6f, 0.7f), new Vector2(0.2f, 0.1f), 0f, "UI\\wood_arrow", GoBack);
        }
